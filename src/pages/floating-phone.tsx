...
export const FloatingPhone: React.FC = () => {
  return (
    <section className="grid h-screen place-content-center p-12">
      <FloatingPhoneContainer />
    </section>
  )
}

const FloatingPhoneContainer = () => {
  return (
    <div
      style={{
...
const Screen = () => {
  return (
    <div className="relative z-0 grid h-full w-full place-content-center overflow-hidden rounded-[20px] bg-background">
      ...
      <button className="absolute bottom-4 left-4 right-4 z-10 rounded-lg border-[1px] dark:bg-black bg-white py-2 text-sm font-medium text-violet-500 backdrop-blur">
        Get Started
      </button>
